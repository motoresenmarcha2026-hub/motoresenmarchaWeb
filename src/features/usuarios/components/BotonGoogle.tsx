...
import { iniciarConGoogle } from "@/features/usuarios/actions";

/** Ícono oficial de Google (multicolor). */
function GoogleIcon() {
  return (
...
/** Botón "Continuar con Google" — dispara el flujo OAuth por server action. */
export function BotonGoogle({ label = "Continuar con Google" }: { label?: string }) {
  return (
